...
static const route_case_t route_cases[] = {
    ...
    {WEB_API_ROUTE_GLOBAL_MACROS, WEB_API_METHOD_GET},
    {WEB_API_ROUTE_GLOBAL_MACROS, WEB_API_METHOD_POST},
    {WEB_API_ROUTE_GLOBAL_MACRO, WEB_API_METHOD_GET},
    {WEB_API_ROUTE_GLOBAL_MACRO, WEB_API_METHOD_PUT},
    {WEB_API_ROUTE_GLOBAL_MACRO, WEB_API_METHOD_DELETE},
    {WEB_API_ROUTE_GLOBAL_MACRO_VALIDATE, WEB_API_METHOD_POST},
    {WEB_API_ROUTE_GLOBAL_MACRO_DUPLICATE, WEB_API_METHOD_POST},
    {WEB_API_ROUTE_GLOBAL_MACROS_REORDER, WEB_API_METHOD_POST},
