...
#define PACKAGE_PREFIX(TYPE_VALUE)                                                                 \
    "{\"schema_version\":1,\"package_type\":\"" TYPE_VALUE "\",\"packages\":["

#define PACKAGE_SUFFIX "],\"macros\":[" LOCAL_MACRO_OBJECT "]}"

static const char VALID_SET_PACKAGE[] = PACKAGE_PREFIX("package") SET_OBJECT PACKAGE_SUFFIX;
static const char VALID_BACKUP_PACKAGE[] = PACKAGE_PREFIX("repository") SET_OBJECT PACKAGE_SUFFIX;
...
static void test_valid_package_and_backup_documents(void) {
    ...
    TEST_CHECK_EQ_U64(STORAGE_DOCUMENT_KIND_PACKAGE, summary.kind);
    ...
    TEST_CHECK_EQ_U64(STORAGE_DOCUMENT_KIND_REPOSITORY, summary.kind);
    TEST_CHECK_EQ_U64(1U, summary.set_count);
}
 ...
 * pretty-printer does not. `GET /api/v1/repository` produces a file a user can open
...
static void test_top_level_contract(void) {
    static const char *const invalid[] = {
        "{}",
        "[]",
        "{\"schema_version\":2,\"package_type\":\"package\",\"packages\":[],\"macros\":[]}",
        "{\"schema_version\":1,\"package_type\":\"future\",\"packages\":[],\"macros\":[]}",
        "{\"schema_version\":1,\"schema_version\":1,\"package_type\":\"package\","
        "\"packages\":[],\"macros\":[]}",
        "{\"schema_version\":1,\"package_type\":\"package\",\"packages\":[],\"macros\":[],"
        "\"future\":true}",
        "{\"schema_version\":1,\"package_type\":\"se\\u0000t\",\"packages\":[],"
        "\"macros\":[]}",
        "{\"schema_version\":1,\"package_type\":\"package\",\"packages\":{},\"macros\":[]}",
        "{\"schema_version\":1,\"package_type\":\"package\",\"packages\":[1],\"macros\":[]}",
        "{\"schema_version\":1,\"package_type\":\"package\",\"packages\":[],\"macros\":[]}x",
    };
    storage_package_summary_t summary = {0};
...
static void test_object_and_reference_validation(void) {
    const char unknown_package_field[] =
        PACKAGE_PREFIX("package") "{\"schema_version\":1,\"id\":\"" SET_ID
                                  "\",\"revision\":1,\"name\":\"Set\",,"
                                  "\"future\":true}" PACKAGE_SUFFIX;
    const char duplicate_package[] =
        PACKAGE_PREFIX("repository") SET_OBJECT "," SET_OBJECT PACKAGE_SUFFIX;
    const char wrong_package_count[] =
        PACKAGE_PREFIX("package") SET_OBJECT "," OTHER_SET_OBJECT PACKAGE_SUFFIX;
    const char bad_macro_syntax[] = PACKAGE_PREFIX("package") SET_OBJECT
        "],\"macros\":[{\"schema_version\":1,\"id\":\"" LOCAL_MACRO_ID
        "\",\"revision\":1,\"name\":\"Bad\",\"source\":\"{BAD}\","
        "\"key_press_ms\":8,\"inter_key_ms\":15,\"package_id\":\"" SET_ID "\"}]}";
    const char duplicate_macro[] = PACKAGE_PREFIX("package") SET_OBJECT
...
static void test_size_and_argument_bounds(void) {
    ...
    TEST_CHECK_APP_ERROR(
        ...
        storage_package_validate(NULL, 1U, STORAGE_DOCUMENT_KIND_PACKAGE, &summary));
    TEST_CHECK_APP_ERROR(APP_ERROR_INVALID_ARGUMENT,
                         storage_package_validate("", 0U, STORAGE_DOCUMENT_KIND_PACKAGE, &summary));
    TEST_CHECK_APP_ERROR(APP_ERROR_INVALID_ARGUMENT,
                         storage_package_validate(VALID_SET_PACKAGE, sizeof(VALID_SET_PACKAGE) - 1U,
                                                  (storage_document_kind_t)99, &summary));
    TEST_CHECK_APP_ERROR(APP_ERROR_INVALID_ARGUMENT,
                         storage_package_validate(VALID_SET_PACKAGE, sizeof(VALID_SET_PACKAGE) - 1U,
                                                  STORAGE_DOCUMENT_KIND_PACKAGE, NULL));
