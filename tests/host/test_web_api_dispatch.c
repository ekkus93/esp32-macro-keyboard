...
static const dispatch_case_t dispatch_cases[] = {
    ...
    {WEB_API_ROUTE_GLOBAL_MACROS, HANDLER_MACROS},
    {WEB_API_ROUTE_GLOBAL_MACRO, HANDLER_MACROS},
    {WEB_API_ROUTE_GLOBAL_MACRO_VALIDATE, HANDLER_MACROS},
    {WEB_API_ROUTE_GLOBAL_MACRO_DUPLICATE, HANDLER_MACROS},
    {WEB_API_ROUTE_GLOBAL_MACROS_REORDER, HANDLER_MACROS},
    ...
    {WEB_API_ROUTE_DIAGNOSTICS_QUARANTINE, HANDLER_ADMINISTRATION},
