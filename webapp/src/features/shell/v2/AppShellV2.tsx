...
/**
 * `diagnostics` belongs to the Settings section for nav-highlighting
 * purposes — it is reachable only from Settings, not its own bottom-nav
 * destination (UI_UX_SPEC_V2 §4/§11).
 */
