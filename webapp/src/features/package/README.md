...
Persisted package listing, selection, CRUD, duplication, import, export, replacement,
ordering, and transactional deletion are not connected to the frontend yet. The
firmware has a tested package repository foundation, but the required HTTP routes are
still missing.
