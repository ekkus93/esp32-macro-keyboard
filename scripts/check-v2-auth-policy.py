...
def uint32_macro(source: str, name: str) -> int:
    match = re.search(rf"^#define\s+{re.escape(name)}\s+UINT32_C\((\d+)\)\s*$", source, re.MULTILINE)
