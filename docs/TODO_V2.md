...
- [x] Provide Move first/up/down/last alternatives to drag and drop. Still no
      ...
      ..."). "Move first"/"Move last" in the pre-v2
      `features/package/PackageManagementPage.tsx` are unaffected (dead-code
      territory pending V2-140, out of this task's scope).
