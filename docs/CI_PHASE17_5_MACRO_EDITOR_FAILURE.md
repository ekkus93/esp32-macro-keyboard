...
```text
85:        expectedRevision: number;
92:      expect(body.expectedRevision).toBe(macro.revision);
127:        error: {
145:    await click(buttonWithText("Go to error"));
224:        error: {

Phase 17.5 macro editor applied
--- generated app-macros.test.tsx ---
...
describe("server-backed macros", () => {
  test("loads the active-set macro library", async () => {
    ...
    expect(getFetchCalls()[0]?.url).toBe(
      `/api/v1/sets/${macroSet.id}/macros`,
    );
    await view.unmount();
  });
  ...
  test("loads, validates, and updates an existing macro", async () => {
    ...
    planFetch((call) => {
      ...
      expect(call.url).toBe(
        `/api/v1/sets/${macroSet.id}/macros/${macroId}`,
      );
  ...
  test("inserts directives, validates, and creates a macro", async () => {
    ...
    expect(
      requiredElement("#macro-source", HTMLTextAreaElement).value,
    ).toBe("{CTRL+L}");
    ...
    planFetch((call) => {
      const body = JSON.parse(typeof call.body === "string" ? call.body : "") as typeof macro;
...
[90msrc/api/client.ts[39m 96ms (unchanged)
[90msrc/api/errors.ts[39m 4ms (unchanged)
[90msrc/api/guards.ts[39m 43ms (unchanged)
...
src/features/macros/MacroEditorPage.tsx 40ms
src/features/macros/MacroLibraryPage.tsx 15ms
...
[90msrc/features/sets/SetSelectionPage.tsx[39m 11ms (unchanged)
...
[90msrc/routing.ts[39m 6ms (unchanged)
...
tests/app-macros.test.tsx 17ms
...
[90meslint.config.js[39m 41ms (unchanged)
...
[90msrc/api/guards.ts[39m 33ms (unchanged)
[90msrc/api/README.md[39m 2ms (unchanged)
...
[90msrc/features/execution/ExecutionResultPage.tsx[39m 5ms (unchanged)
[90msrc/features/execution/README.md[39m 3ms (unchanged)
[90msrc/features/macros/macroDraft.ts[39m 13ms (unchanged)
...
[1m[46m RUN [49m[22m [36mv3.2.4 [39m[90m/home/runner/work/esp32-macro-keyboard/esp32-macro-keyboard/webapp[39m
 ...
 [32m✓[39m tests/api.test.ts [2m([22m[2m20 tests[22m[2m)[22m[32m 48[2mms[22m[39m
 [32m✓[39m tests/app-auth.test.tsx [2m([22m[2m7 tests[22m[2m)[22m[32m 153[2mms[22m[39m
 [31m❯[39m tests/app-macros.test.tsx [2m([22m[2m5 tests[22m[2m | [22m[31m4 failed[39m[2m)[22m[32m 252[2mms[22m[39m
   [32m✓[39m server-backed macros[2m > [22mloads the active-set macro library[32m 58[2mms[22m[39m
[31m   [31m×[31m server-backed macros[2m > [22mloads, validates, and updates an existing macro[39m[32m 72[2mms[22m[39m
...
[31m   [31m×[31m server-backed macros[2m > [22mshows exact parser coordinates and keeps Save disabled[39m[32m 36[2mms[22m[39m
[31m     → Unexpected console.error: An update to %s inside a test was not wrapped in act(...).
...
This ensures that you're testing the behavior the user would see in the browser. Learn more at https://react.dev/link/wrap-tests-with-act[39m
[31m   [31m×[31m server-backed macros[2m > [22minserts directives, validates, and creates a macro[39m[32m 38[2mms[22m[39m
[31m     → Unexpected console.error: An update to %s inside a test was not wrapped in act(...).
...
This ensures that you're testing the behavior the user would see in the browser. Learn more at https://react.dev/link/wrap-tests-with-act[39m
[31m   [31m×[31m server-backed macros[2m > [22msurfaces stale-revision conflicts without overwriting the draft[39m[32m 45[2mms[22m[39m
[31m     → Unexpected console.error: An update to %s inside a test was not wrapped in act(...).
...
This ensures that you're testing the behavior the user would see in the browser. Learn more at https://react.dev/link/wrap-tests-with-act[39m
 [32m✓[39m tests/app-execution.test.tsx [2m([22m[2m11 tests[22m[2m)[22m[32m 140[2mms[22m[39m
 [32m✓[39m tests/app-sets.test.tsx [2m([22m[2m4 tests[22m[2m)[22m[32m 135[2mms[22m[39m
 [32m✓[39m tests/app-routing.test.tsx [2m([22m[2m21 tests[22m[2m)[22m[32m 226[2mms[22m[39m
 [32m✓[39m tests/guards.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 16[2mms[22m[39m
 [32m✓[39m tests/error-banner.test.tsx [2m([22m[2m3 tests[22m[2m)[22m[32m 37[2mms[22m[39m
...
[2m      Tests [22m [1m[31m4 failed[39m[22m[2m | [22m[1m[32m71 passed[39m[22m[90m (75)[39m
[2m   Start at [22m 00:29:54
[2m   Duration [22m 2.92s[2m (transform 356ms, setup 254ms, collect 780ms, tests 1.01s, environment 3.99s, prepare 751ms)[22m
