...
typedef int (*web_adapter_send_chunk_fn)(void *context, const uint8_t *buffer, size_t length);
...
typedef int (*web_adapter_route_register_fn)(void *context, void *handle, size_t route_index);
