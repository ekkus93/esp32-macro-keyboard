...
typedef app_error_code_t (*web_execution_macro_read_fn)(
    void *context, const storage_macro_location_t *location, const app_uuid_t *macro_id,
    macro_t *out_macro);
typedef app_error_code_t (*web_execution_procedure_read_fn)(
    void *context, const app_uuid_t *set_id, const app_uuid_t *procedure_id,
    procedure_t *out_procedure);
typedef app_error_code_t (*web_execution_compile_fn)(
    void *context, const char *source, size_t source_length,
...
typedef app_error_code_t (*web_execution_uuid_generate_fn)(void *context,
                                                            app_uuid_t *out_uuid);
